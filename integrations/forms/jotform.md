...
Search for "**Clearout,**" to select the **Clearout widget** for email validation. Simply **drag and drop** the widget to the form where you wish to add the email field. _(The label can be changed.)_
{% endstep %}
